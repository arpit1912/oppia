...
export class ExplorationDataService {
  ...
  autosaveChangeList(
    ...
    this.httpClient.put(this.explorationDraftAutosaveUrl, {
      change_list: changeList,
      version: this.explorationData.data.version
    }).toPromise().then(function(response) {
      this.draftChangeListId = response.data.draft_change_list_id;
  ...
  discardDraft(successCallback, errorCallback): void {
    this.httpClient.post(
      this.explorationDraftAutosaveUrl, {}).toPromise().then(function() {
      this.localStorageService.removeExplorationDraft(this.explorationId);
      if (successCallback) {
        successCallback();
      }
